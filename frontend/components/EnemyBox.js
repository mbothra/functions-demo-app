        ...
        <div id="enemy-container">
          ...
          <div id="enemy-info-box">
            <div className="d-flex justify-content-between align-items-center">
              ...
              <Select
                options={playerNames}
                onChange={this.props.handleEnemySelect}
                value={this.props.selectedEnemy}
          ...
          {
            this.props.selectedEnemy &&
            <div className="mr-sm-4 avatar-box">
              <EnemyAvatar enemyFaint={this.props.enemyFaint} imageUrl={this.props.selectedEnemy?.imageUrl}/>
              <div className="oval" />
            </div>
          }
